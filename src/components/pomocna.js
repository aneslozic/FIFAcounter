      ...
      return(
            niz.map(x => (
                <div>
                    ...
                    <input id={"Player"+x.p1+"vs"+x.p2 } type="text" onChange={this.handleChange}/>
                    <div> : </div>
                    ...
                    <button onClick={() => {
                            ...
                            player.golRazlika += (val - val1 >= 0) ? val - val1 : val1 - val;
                            player.bodovi += (val > val1) ? 3 : (val === val1) ? 1 : 0;
                            player1.postihnutigolovi += val1;
                            player1.primljenigolovi += val;
                            player1.golRazlika += (val1 - val >= 0) ? val1 - val : val - val1;
